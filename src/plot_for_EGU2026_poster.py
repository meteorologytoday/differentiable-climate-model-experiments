...
truth_year = 20
exp_root = Path("./experiment_set")
exp_name = "output_T31_02-04_aquaplanet_equilibrium_with_1year_spinup_sst_30days_avg"

algo_names = ["Mixed_RMSProp_RMSPropMomentum", ]#"RMSPropMomentum", "RMSProp"]
...
data = {
    algo_name : xr.open_mfdataset(str(exp_root / exp_name / f"training_{algo_name:s}/training*.nc"), engine="netcdf4", combine="nested", concat_dim="iteration").isel(iteration=slice(None, -10))
